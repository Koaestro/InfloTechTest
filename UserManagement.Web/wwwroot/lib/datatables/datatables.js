 ...
 *   https://datatables.net/download/#bs5/dt-2.3.2/b-3.2.4/date-1.5.6/sc-2.4.3/sp-2.3.4
 *
 * Included libraries:
 *   DataTables 2.3.2, Buttons 3.2.4, DateTime 1.5.6, Scroller 2.4.3, SearchPanes 2.3.4
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "bs5/dt-2.3.2/b-3.2.4/date-1.5.6/sc-2.4.3/sp-2.3.4",
